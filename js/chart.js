...
(function (global, factory) {
    ...
    const _lookupByKey = (table, key, value, last) => _lookup(table, value, last
    ...
    class Chart {
        constructor(item, userConfig) {
            ...
            if (existingChart) {
                throw new Error('Canvas is already in use. Chart with ID \'' + existingChart.id + '\'' +
        ...
        _getUniformDataChanges() {
            ...
            const makeSet = (idx) => new Set(_dataChanges
                .filter(c => c[0] === idx)
